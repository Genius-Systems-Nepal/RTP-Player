...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--prefix=/Users/sabin/Documents/work/RtpPlayer/ffmpeg/libs/armeabi-v7a --disable-shared --enable-static --disable-everything --enable-small --enable-pthreads --cross-prefix=/Users/sabin/android-env/android-ndk-r10d/toolchains/arm-linux-androideabi-4.9/prebuilt/darwin-x86_64/bin/arm-linux-androideabi- --target-os=linux --arch=arm --enable-cross-compile --sysroot=/Users/sabin/android-env/android-ndk-r10d/platforms/android-19/arch-arm/ --extra-cflags='-Os -fpic -march=armv7-a -mfloat-abi=softfp -mfpu=neon' --extra-ldflags= --enable-decoder=h264 --enable-parser=h264 --enable-bsf=h264_mp4toannexb
prefix=/Users/sabin/Documents/work/RtpPlayer/ffmpeg/libs/armeabi-v7a
...
ARCH=arm
INTRINSICS=neon
CC=/Users/sabin/android-env/android-ndk-r10d/toolchains/arm-linux-androideabi-4.9/prebuilt/darwin-x86_64/bin/arm-linux-androideabi-gcc
CXX=/Users/sabin/android-env/android-ndk-r10d/toolchains/arm-linux-androideabi-4.9/prebuilt/darwin-x86_64/bin/arm-linux-androideabi-g++
AS=/Users/sabin/android-env/android-ndk-r10d/toolchains/arm-linux-androideabi-4.9/prebuilt/darwin-x86_64/bin/arm-linux-androideabi-gcc
OBJCC=/Users/sabin/android-env/android-ndk-r10d/toolchains/arm-linux-androideabi-4.9/prebuilt/darwin-x86_64/bin/arm-linux-androideabi-gcc
LD=/Users/sabin/android-env/android-ndk-r10d/toolchains/arm-linux-androideabi-4.9/prebuilt/darwin-x86_64/bin/arm-linux-androideabi-gcc
DEPCC=/Users/sabin/android-env/android-ndk-r10d/toolchains/arm-linux-androideabi-4.9/prebuilt/darwin-x86_64/bin/arm-linux-androideabi-gcc
DEPCCFLAGS= $(CPPFLAGS)
DEPAS=/Users/sabin/android-env/android-ndk-r10d/toolchains/arm-linux-androideabi-4.9/prebuilt/darwin-x86_64/bin/arm-linux-androideabi-gcc
DEPASFLAGS= $(CPPFLAGS)
YASM=yasm
DEPYASM=yasm
AR=/Users/sabin/android-env/android-ndk-r10d/toolchains/arm-linux-androideabi-4.9/prebuilt/darwin-x86_64/bin/arm-linux-androideabi-ar
ARFLAGS=rcD
AR_O=$@
RANLIB=/Users/sabin/android-env/android-ndk-r10d/toolchains/arm-linux-androideabi-4.9/prebuilt/darwin-x86_64/bin/arm-linux-androideabi-ranlib -D
STRIP=/Users/sabin/android-env/android-ndk-r10d/toolchains/arm-linux-androideabi-4.9/prebuilt/darwin-x86_64/bin/arm-linux-androideabi-strip
CP=cp -p
LN_S=ln -s -f
CPPFLAGS= --sysroot=/Users/sabin/android-env/android-ndk-r10d/platforms/android-19/arch-arm/ -isysroot /Users/sabin/android-env/android-ndk-r10d/platforms/android-19/arch-arm/ -D_ISOC99_SOURCE -D_FILE_OFFSET_BITS=64 -D_LARGEFILE_SOURCE -Dstrtod=avpriv_strtod -DPIC -DZLIB_CONST
CFLAGS=  -Os -fpic -march=armv7-a -mfloat-abi=softfp -mfpu=neon -march=armv7-a -std=c11 -fomit-frame-pointer -fPIC -marm -pthread -g -Wdeclaration-after-statement -Wall -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Wno-pointer-to-int-cast -Wstrict-prototypes -Wempty-body -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wno-pointer-sign -Os -fno-math-errno -fno-signed-zeros -fno-tree-vectorize -Werror=format-security -Werror=implicit-function-declaration -Werror=missing-prototypes -Werror=return-type -Werror=vla -Wformat -fdiagnostics-color=auto -Wno-maybe-uninitialized
...
LD_PATH=-L
DLLTOOL=
WINDRES=/Users/sabin/android-env/android-ndk-r10d/toolchains/arm-linux-androideabi-4.9/prebuilt/darwin-x86_64/bin/arm-linux-androideabi-windres
DEPWINDRES=/Users/sabin/android-env/android-ndk-r10d/toolchains/arm-linux-androideabi-4.9/prebuilt/darwin-x86_64/bin/arm-linux-androideabi-gcc
DOXYGEN=doxygen
LDFLAGS=   --sysroot=/Users/sabin/android-env/android-ndk-r10d/platforms/android-19/arch-arm/ -isysroot /Users/sabin/android-env/android-ndk-r10d/platforms/android-19/arch-arm/ -march=armv7-a -Wl,--as-needed -Wl,-z,noexecstack -Wl,--warn-common -Wl,-rpath-link=libpostproc:libswresample:libswscale:libavfilter:libavdevice:libavformat:libavcodec:libavutil:libavresample
LDEXEFLAGS=
LDLIBFLAGS=
